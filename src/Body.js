  ...
  return (
    <div className="Body">
      ...
      <div className="center">
        ...
        <div className="Deck">
          <div className="Carta_1" onClick={() => chooseCard(Carta_des_1)} />
          <div className="Carta_1" onClick={() => chooseCard(Carta_des_1)} />
          <div className="Carta_1" onClick={() => chooseCard(Carta_des_1)} />
          <div className="Carta_2" onClick={() => chooseCard(Carta_des_2)} />
          <div className="Carta_2" onClick={() => chooseCard(Carta_des_2)} />
          <div className="Carta_3" onClick={() => chooseCard(Carta_des_3)} />
          <div className="Carta_3" onClick={() => chooseCard(Carta_des_3)} />
          <div className="Carta_3" onClick={() => chooseCard(Carta_des_3)} />
          <div className="Carta_4" onClick={() => chooseCard(Carta_des_4)} />
          <div className="Carta_4" onClick={() => chooseCard(Carta_des_4)} />
          <div className="Carta_4" onClick={() => chooseCard(Carta_des_4)} />
          <div className="Carta_5" onClick={() => chooseCard(Carta_des_5)} />
          <div className="Carta_6" onClick={() => chooseCard(Carta_des_6)} />
          <div className="Carta_7" onClick={() => chooseCard(Carta_des_7)} />
          <div className="Carta_7" onClick={() => chooseCard(Carta_des_7)} />
          <div className="Carta_8" onClick={() => chooseCard(Carta_des_8)} />
          <div className="Carta_8" onClick={() => chooseCard(Carta_des_8)} />
          <div className="Carta_8" onClick={() => chooseCard(Carta_des_8)} />
          <div className="Carta_9" onClick={() => chooseCard(Carta_des_9)} />
          <div className="Carta_9" onClick={() => chooseCard(Carta_des_9)} />
          <div className="Carta_9" onClick={() => chooseCard(Carta_des_9)} />
          <div className="Carta_10" onClick={() => chooseCard(Carta_des_10)} />
          <div className="Carta_11" onClick={() => chooseCard(Carta_des_11)} />
          <div className="Carta_11" onClick={() => chooseCard(Carta_des_11)} />
          <div className="Carta_12" onClick={() => chooseCard(Carta_des_12)} />
          <div className="Carta_12" onClick={() => chooseCard(Carta_des_12)} />
          <div className="Carta_13" onClick={() => chooseCard(Carta_des_13)} />
          <div className="Carta_14" onClick={() => chooseCard(Carta_des_14)} />
          <div className="Carta_14" onClick={() => chooseCard(Carta_des_14)} />
          <div className="Carta_14" onClick={() => chooseCard(Carta_des_14)} />
          <div className="Carta_15" onClick={() => chooseCard(Carta_des_15)} />
          <div className="Carta_15" onClick={() => chooseCard(Carta_des_15)} />
          <div className="Carta_15" onClick={() => chooseCard(Carta_des_15)} />
          <div className="Carta_16" onClick={() => chooseCard(Carta_des_16)} />
          <div className="Carta_17" onClick={() => chooseCard(Carta_des_17)} />
          <div className="Carta_18" onClick={() => chooseCard(Carta_des_18)} />
          <div className="Carta_18" onClick={() => chooseCard(Carta_des_18)} />
          <div className="Carta_18" onClick={() => chooseCard(Carta_des_18)} />
          <div className="Carta_19" onClick={() => chooseCard(Carta_des_19)} />
          <div className="Carta_20" onClick={() => chooseCard(Carta_des_20)} />
        </div>
        <div className="Extra">
      ...
      <div className="Extra_deck">
        <div className="Carta_21" onClick={() => chooseCard(Carta_des_21)} />
        <div className="Carta_22" onClick={() => chooseCard(Carta_des_22)} />
        <div className="Carta_23" onClick={() => chooseCard(Carta_des_23)} />
        <div className="Carta_24" onClick={() => chooseCard(Carta_des_24)} />
        <div className="Carta_25" onClick={() => chooseCard(Carta_des_25)} />
        <div className="Carta_26" onClick={() => chooseCard(Carta_des_26)} />
        <div className="Carta_27" onClick={() => chooseCard(Carta_des_27)} />
        <div className="Carta_28" onClick={() => chooseCard(Carta_des_28)} />
        <div className="Carta_29" onClick={() => chooseCard(Carta_des_29)} />
        <div className="Carta_30" onClick={() => chooseCard(Carta_des_30)} />
        <div className="Carta_31" onClick={() => chooseCard(Carta_des_31)} />
        <div className="Carta_32" onClick={() => chooseCard(Carta_des_32)} />
        <div className="Carta_32" onClick={() => chooseCard(Carta_des_32)} />
        <div className="Carta_33" onClick={() => chooseCard(Carta_des_33)} />
        <div className="Carta_34" onClick={() => chooseCard(Carta_des_34)} />
      </div>
      <div className="Side">
        <div className="Side_text">Side</div>
      </div>
      <div className="Side_deck" />
      <div className="rigth">
